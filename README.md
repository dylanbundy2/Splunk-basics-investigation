...
This project documents hands-on experience using Splunk Enterprise to analyse security logs and investigate suspicious authentication activity.  The investigation was completed as part of practical SOC training using TryHackMe. 
## Objectives
